...
namespace JerryPlat.Pay.WxPay
{
    public class WxPayApi
    {
        ...
        {
            WxPayData data = GetJSSDKConfig();
            return data == null ? "" : SerializationHelper.ToJson(data.GetValues());
        }
        ...
        */
        ...
        public static WxPayData GetJSSDKConfig()
        {
            JsApiConfig jsApiConfig = new JsApiConfig();
            ...
            WxTicket wxticket = helper.GetWxTicket(WxTicketType.ACCESS_TOKEN);
            ...
            if (wxticket == null || wxticket.ExpireTime < ConvertDateTimeInt(DateTime.Now))
            {
                ...
                helper.Save(WxTicketType.ACCESS_TOKEN, new WxTicket
                {
                    Ticket = access_token,
            ...
            wxticket = helper.GetWxTicket(WxTicketType.TICKET);
            ...
            if (wxticket == null || wxticket.ExpireTime < ConvertDateTimeInt(DateTime.Now))
            {
                ...
                helper.Save(WxTicketType.TICKET, new WxTicket
                {
                    Ticket = ticket,
                    ExpireTime = ConvertDateTimeInt(DateTime.Now) + 7180
                });
