...
namespace JerryPlat.Utils.Helpers
{
    public static class CookieHelper
    {
        ...
        public static void SetTokenCookie(TokenModel model)
        {
            SetCookie(ConstantHelper.TokenType, model.token_type, expiresDate: DateTime.Now.AddDays(30));
            SetCookie(ConstantHelper.Token, model.access_token, expiresDate: DateTime.Now.AddSeconds(model.expires_in));
            SetCookie(ConstantHelper.RefreshToken, model.refresh_token, expiresDate: DateTime.Now.AddDays(30));
        }
